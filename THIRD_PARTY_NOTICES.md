...
aibox-drpy-source/vendor/crypto-js/ 来自 [brix/crypto-js](https://github.com/brix/crypto-js)，使用 MIT License：
...
完整许可证保留在 aibox-drpy-source/vendor/crypto-js/LICENSE。

通过 npm ci 安装的依赖不提交到仓库；其许可证信息以各 npm 包随附的许可证为准。
